...
import 'package:superlegit_app/Widgets/admob.dart';
import 'package:superlegit_app/Widgets/constant.dart';
import 'package:superlegit_app/Widgets/drawer.dart';
...
class _ContactState extends State<Contact> {
  ...
  void initState() {
    FirebaseAdMob.instance.initialize(
      appId: "ca-app-pub-5626633173381353~1688049590",);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        actions: [
          GestureDetector(
              onTap: (){
                RewardedVideoAd.instance.load(adUnitId: "ca-app-pub-5626633173381353/9674753779",targetingInfo: Admob.targetingInfo);
